  ...
  const steps = [
    {
      ...
      description:
        'Connect your Stacks wallet and deposit STX tokens to join our automated arbitrage pool. Minimum investment starts at just 10 STX.',
    },
    {
      icon: <ArbitrageIcon />,
      title: 'Automated Arbitrage',
      description:
        'Our smart contract algorithms scan multiple exchanges 24/7, identifying profitable price differences and executing trades automatically.',
    },
    {
      icon: <WithdrawIcon />,
      title: 'Earn & Withdraw',
      description:
        'Watch your earnings grow in real-time through our dashboard. Withdraw your profits anytime with just a few clicks.',
    },
  ];
    ...
    >
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          >
            Get started with crypto arbitrage in three simple steps. No trading
            experience required.
          </motion.p>
        </motion.div>
