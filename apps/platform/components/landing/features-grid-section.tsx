  ...
  const features = [
    {
      ...
      description:
        'Built on Stacks blockchain with smart contracts ensuring your funds are always secure and transactions are transparent.',
    },
    {
      icon: <AutomationIcon />,
      title: 'Fully Automated',
      description:
        'Our AI-powered algorithms work 24/7 to identify and execute profitable arbitrage opportunities without any manual intervention.',
    },
    {
      icon: <ProfitabilityIcon />,
      title: 'Consistent Returns',
      description:
        'Earn steady returns from market inefficiencies across multiple exchanges with our proven arbitrage strategies.',
    },
    {
      icon: <RealTimeIcon />,
      title: 'Real-Time Monitoring',
      description:
        'Track your investments and earnings in real-time through our intuitive dashboard with live updates.',
    },
    {
      icon: <CommunityIcon />,
      title: 'Community Driven',
      description:
        'Join a thriving community of investors and stay updated with our integrated Telegram notifications.',
    },
    {
      icon: <TransparencyIcon />,
      title: 'Full Transparency',
      description:
        'Every transaction is recorded on the blockchain, providing complete transparency and auditability of all operations.',
    },
  ];
    ...
    >
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          >
            Built with cutting-edge technology and designed for both beginners
