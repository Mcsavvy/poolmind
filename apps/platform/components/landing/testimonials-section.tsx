    ...
    >
      <Card className='bg-gradient-to-r from-accent/30 to-accent/50 border-primary/30 p-6 animate-premium-pulse'>
        <CardContent className='flex flex-col lg:flex-row items-center justify-between p-0 space-y-4 lg:space-y-0'>
          <div className='flex items-center space-x-4 text-center lg:text-left'>
            ...
            <div>
              ...
              <p className='text-muted-foreground text-sm'>
                Get real-time updates and connect with other investors
              </p>
            </div>
          </div>
          <motion.div
          ...
          >
            <Button
              className='w-full lg:w-auto bg-foreground text-primary-foreground px-6 py-4 text-base font-semibold'
              asChild
            >
...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        'PoolMind made crypto arbitrage accessible to me as a beginner. Great returns with zero stress!',
      name: 'Sarah Chen',
    ...
    {
      quote:
        'Finally, a platform that does the heavy lifting. My STX is working harder than ever before.',
      name: 'Mike Rodriguez',
      username: 'mikerodz',
      imageUrl: undefined,
      rating: 5,
    ...
    {
      quote:
        'Transparent, automated, and profitable. PoolMind delivers exactly what it promises.',
      name: 'Alex Thompson',
    ...
    {
      quote:
        'The real-time updates and Telegram integration keep me informed without being overwhelming.',
      name: 'Emma Wilson',
      username: 'emmaw_defi',
      imageUrl: undefined,
      rating: 5,
    ...
    {
      quote:
        'Smart contracts give me peace of mind. My funds are secure while earning consistent returns.',
      name: 'David Park',
    ...
    {
      quote:
        "Best decision I made this year. PoolMind's arbitrage engine is incredibly efficient.",
      name: 'Lisa Zhang',
