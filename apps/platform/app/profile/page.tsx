        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold tracking-tight">Authentication Methods</h2>
              <p className="text-muted-foreground">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Image src="/stx.png" alt="Stacks" width={20} height={20} className="w-8 h-8" />
                  ...
                  <CardDescription>
                    Your primary authentication method using your Stacks wallet signature
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="p-3 bg-background rounded-lg">
                      <p className="text-sm text-muted-foreground font-medium">
                        Wallet authentication is your primary and most secure login method
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        This cannot be disabled as it&apos;s required for account access
                      </p>
                    </div>
                  </div>
                </CardContent>
