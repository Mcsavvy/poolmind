        ...
        <div className='flex items-center justify-between'>
          <div className='flex flex-col space-y-2'>
            ...
            <p className='text-muted-foreground'>
              Here&apos;s an overview of your PoolMind account and investment
              performance
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              {isLoadingStats ? (
                ...
                <>
                  <div
                    className={`text-2xl font-bold ${pnlFormatted.colorClass}`}
                  >
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-medium'>
                      {poolInfo && userBalance
                        ? (
                            (Number(userBalance.plmdBalance) /
                              Number(poolInfo.totalShares)) *
                            100
                          ).toFixed(4)
                        : '0.0000'}
                      %
            ...
            {isLoadingTransactions ? (
              ...
              <div className='flex flex-col items-center justify-center p-8 text-center'>
                ...
                <p className='text-muted-foreground mb-4'>
                  Start by contributing to the arbitrage pool to earn PLMD
                  tokens.
                </p>
                <WalletConnectedDepositButton />
              </div>
              ...
              {user?.telegramAuth && (
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center space-x-2'>
                    <span className='text-sm'>
                      @
                      {user.telegramAuth.username ||
                        user.telegramAuth.firstName}
                    </span>
                    <Badge variant='secondary' className='text-xs'>
                      Connected
                    </Badge>
